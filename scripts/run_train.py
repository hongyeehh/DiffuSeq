...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--resume_checkpoint", type=str, default="none", help="path to resume checkpoint, like xxx/xxx.pt"
    )
    ...
    parser.add_argument(
        "--vocab", type=str, default="bert", help="use bert vocab or load external vocab dict if given as path"
    )
    parser.add_argument(
        "--use_plm_init",
        type=str,
    ...
    Model_FILE = (
        f"diffuseq_{args.dataset}_h{args.hidden_dim}_lr{args.lr}"
